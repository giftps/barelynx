...
function content_66ec2e2cd12055_80473003 (Smarty_Internal_Template $_smarty_tpl) {
?>/**
 * Index:
 *
 * 01. BASIC
...
.landing-form {
  flex: 1 1 80%; /* Take up 80% of the height */
  padding-top: 50px;
  max-width: 550px;
  margin: 0 auto;
}
...
.footer-links {
  flex: 0 1 10%; /* Take up 20% of the height */
}
