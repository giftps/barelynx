...
<div class="x-form publisher" data-handle="{$_handle}" {if $_id}data-id="{$_id}" {/if}>
  ...
  <div class="publisher-message">
    ...
    <div class="colored-text-wrapper">
      <textarea dir="auto" class="js_autosize js_mention js_publisher-scraper" data-init-placeholder='{__("Share your thoughts")}' placeholder='{__("Share your thoughts...")}'>{if $page == "share" && $url}{$url}{/if}</textarea>
    </div>
